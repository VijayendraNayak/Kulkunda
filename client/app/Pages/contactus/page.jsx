        ...
        <div className="bg-orange-100 mt-10 p-8 rounded-lg">
          ...
          <div className="mt-8">
            ...
            <div className="flex items-center">
              ...
              <p className="text-gray-700"><a href="mailto:shreebasaveshwaratemplekulkund@gmail.com" class="inline-block px-4 py-2 bg-orange text-black rounded-md transition-all hover:bg-dark-orange hover:text-green focus:outline-none focus:ring focus:border-black-300">shreebasaveshwaratemplekulkund@gmail.com</a></p>
            </div>
          </div>
        </div>
        _{/*map*/}
