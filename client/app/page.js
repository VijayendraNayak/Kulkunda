...
const Page = () => {
  ...
  {/* Left half - Content */}
  <div className='flex-1 md:mr-5 lg:mr-10 md:ml-5 lg:ml-10'>
    <div className='bg-ora p-5 rounded-md hover:scale-105'>
  ...
  {/* Right half - Image */}
  <div className='w-full lg:w-1/3 md:w-1/2 mb-5 md:mb-5 lg:mb-5 align-center'>
    <Image
      src={Temple}
    ...
    />
      ...
      <div className='flex flex-col md:flex-row md:p-5'>
        <div className='w-full md:w-2/3 lg:mr-10'>
          {/* Your content here */}
        </div>
        <div className='w-full md:w-1/3 mt-5 md:mt-10'>
          <div className='bg-ora p-5 rounded-md hover:scale-105'>
