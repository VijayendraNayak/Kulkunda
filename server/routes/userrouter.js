...
const { register, login, google, logout, updateProfile, updatePassword, numberOfUsers, forgetpass, getSingleUser, deleteUser, updateRole } = require("../controllers/usercontroller");
